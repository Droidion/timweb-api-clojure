(ns timweb-api.router
  ...
  (:require [reitit.ring :as r]
            ...
            [timweb-api.handlers.api.brand :as handler-brand]
            [timweb-api.handlers.api.status :as handler-status]
            [timweb-api.handlers.api.user :as handler-user]
            [timweb-api.handlers.html :as handler-html]
